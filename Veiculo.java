...
class Veiculo
{
    ...
    public void imprimirInformacoes(){
        if(this.resposta == 1){
        	System.out.println(" ");
        	System.out.println("A bicicleta tem " + this.getmarcha() + " marchas.");
        	if (bagageiro == true){
        		System.out.println(" ");
        		System.out.println("A bicicleta vem acompanhada com bagageiro. ");
        	}else{
        	  	System.out.println(" ");
...
public class Main{    
	public static void main(String[] args) {
	   Veiculo bike = new Veiculo(1, 2, 3);
       System.out.println(" ");
